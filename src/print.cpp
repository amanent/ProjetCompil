...
void pprintTree2(TreeP tree, std::string op) {
  //printf("(");
...
void pprintTree2full(TreeP tree, std::string before, std::string un, std::string  after) {
...
void pprintTree3(TreeP tree, std::string before, std::string un, std::string  deux, std::string  after) {
  printf("%s", before.c_str());
  ppprint(getChild(tree, 0));
  printf("%s", un.c_str());
  ppprint(getChild(tree, 1));
