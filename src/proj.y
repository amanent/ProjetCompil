...
%token DECL LSTARG BLCDECL CAST INSTA INSTR MSGSNT MSGSNTS SELECT SELECTS LSTINST CMPAFF DIRAFF 
/* --------------------------------- */
...
Exp2		:	'(' Exp ')'									{ pprintf("exp21"); $$ = $2; } 
			...
			|	Idcl '.' Id									{ pprintf("exp25"); $$ = makeTree(SELECTS, 2, makeLeafStr(IDCL, $1), makeLeafStr(ID, $3));}
