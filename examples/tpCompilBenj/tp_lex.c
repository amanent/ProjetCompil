...
int main(int argc, char **argv) {
  ...
  while (1) {
    ...
    case MUL:
    case DIV:
      if (verbose) printf("Operateur arithmetique:\t%s\n", yytext);
      break;
    case IF: if (verbose) printf("if\n"); break;
    case THEN: if (verbose) printf("then\n"); break;   
    case ELSE: if (verbose) printf("else\n"); break;
    case GET: if (verbose) printf("get\n"); break;
    case PUT: if (verbose) printf("put\n"); break;
    case RELOP:
